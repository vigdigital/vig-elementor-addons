...
define( 'VIG_ADDON_VERSION', '2.0.3' );
...
// Link "Settings" trong danh sách plugin (Plugins screen) → trang settings dưới VIG Toolkit.
add_filter(
	'plugin_action_links_' . plugin_basename( __FILE__ ),
	function ( $links ) {
		$settings_link = '<a href="' . esc_url( admin_url( 'admin.php?page=vig-elementor-addons' ) ) . '">'
			. esc_html__( 'Settings', 'vig-elementor-addons' ) . '</a>';
